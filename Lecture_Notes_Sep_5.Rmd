...
# 3.Binary + Continuous
 ...
 $lm(kid.score ~ 1+mon.hs + mon.iq)$, $y = \beta_0 + \beta_1*X_{hs} + \beta_2*X_{iq}$  
 $\beta_0 = 25.73 + 0.56*X_{hs} + 5.95*X_{iq}$  
 ...
 the resulting model can be written as:  
    mon with no HS: $y = 25.73 + 0.56X_{iq}$  
    mon with HS:    $y = 31.68 + 0.56X_{iq}$   
...
# 4. Interations
 ...
 $y = \beta_0 + \beta_1X_{hs} + \beta_2X_{iq} + \beta_3X_{hs}X_{iq}$  
