...
2. Including the amount owed at the time of charge off into the data, a model can be built to estimate the actual expected loss of money thus improve the risk analysis model to a dollar amount losses.
